...
import { FaLinkedin, FaGithub, FaWhatsapp, FaDiscord, FaLine } from "react-icons/fa";
...
const Footer = () => {
    return (
        <footer className="py-12 border-t border-white/10 bg-black relative">
            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
                    ...
                    {socialLinks.map((link) => {
                        ...
                        return (
                            <a
                                ...
                                title={link.name}
                                className={`text-3xl text-zinc-700 transition-all duration-300 transform hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.5)] ${link.color}`}
                            >
                                <Icon />
                            </a>
                        );
                ...
                <p className="text-zinc-600 text-sm font-mono">
                    SYSTEM_VERSION_2.1 // (C) {new Date().getFullYear()} FATHAN YAZID SATRIANI
                </p>
            </div>
        </footer>
    );
